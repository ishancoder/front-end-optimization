...
var resizePizzas = function(size) {
  ...
  function changeSliderLabel(size) {
    var sizeElement = document.querySelector("#pizzaSize");
    switch(size) {
      case "1":
        sizeElement.innerHTML = "Small";
        return;
      case "2":
        sizeElement.innerHTML = "Medium";
        return;
      case "3":
        sizeElement.innerHTML = "Large";
        return;
      default:
  ...
  function changePizzaSizes(size) {
    ...
    var dx = determineDx(randomPizzaContainer[0], size, oldWidth);
...
document.addEventListener('DOMContentLoaded', function() {
  var s = 256;
  var cols = 8;
  var rows = Math.ceil(window.screen.height / 232);
  var elem;
